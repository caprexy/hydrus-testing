...
class MediaContainer( QW.QWidget ):
    ...
    def _MakeMediaWindow( self ):
        ...
        if self._show_action in ( CC.MEDIA_VIEWER_ACTION_DO_NOT_SHOW_ON_ACTIVATION_OPEN_EXTERNALLY, CC.MEDIA_VIEWER_ACTION_DO_NOT_SHOW ):
            ...
            # Special handling for CBZ files - show thumbnail instead of trying to render as image
                ...
                with zipfile.ZipFile( path, 'r' ) as cbz:
                    ...
                    if image_files:
                        ...
                        with cbz.open(first_image) as img_file:
                            ...
                            # Resize to reasonable thumbnail size (up to 1200px on longest side)
                            max_size = 1200
                            ...
                            q_image = QG.QImage(img_array.data, width, height, bytes_per_line, QG.QImage.Format.Format_RGB888)
                            self._thumbnail_qt_pixmap = QG.QPixmap.fromImage(q_image)
