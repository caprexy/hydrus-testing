...
APPLICATIONS_WITH_THUMBNAILS = { IMAGE_SVG, APPLICATION_PDF, APPLICATION_FLASH, APPLICATION_CLIP, APPLICATION_PROCREATE, APPLICATION_CBZ, APPLICATION_PPTX, APPLICATION_PAINT_DOT_NET }.union( VIEWABLE_IMAGE_PROJECT_FILES )
